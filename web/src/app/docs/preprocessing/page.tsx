...
print(converted_all.dtypes)`}
          ...
          <MethodCard
            ...
            description="Comprehensive data cleaning pipeline (fully implemented in v0.3.1). Handles missing values, removes duplicates, converts dtypes, detects and removes outliers, scales/normalizes data, applies log or sqrt transformations, and drops or keeps specific columns in a single call."
            parameters={[
