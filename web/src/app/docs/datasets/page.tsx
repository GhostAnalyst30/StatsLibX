      ...
      <section className="mb-12">
        ...
        <div className="method-list">
          <MethodCard
            ...
            description="Generate a synthetic dataset with <code>n_rows</code> rows according to a schema dict. Each key in the schema defines a column and its distribution. Uses <code>numpy.random.Generator</code> for reproducible random sampling (v0.3.0). A random seed is set to 42 if not provided."
            parameters={[
